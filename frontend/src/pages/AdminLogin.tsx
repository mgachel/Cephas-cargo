...
export default function AdminLogin() {
  ...
  <div className="relative z-10 flex flex-col justify-center px-12" style={{ color: '#FFC300' }}>
          <div className="flex items-center mb-8">
            <div>
              <img src="/wavemova_0.png" alt="Cephas Cargo and logistics" className="mb-8 w-64 h-auto" />
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center mb-6">
            <img src="/wavemova_copy.png" alt="Cephas Cargo Logo" className="w-40 h-auto mx-auto mb-4" /> 
          </div>
