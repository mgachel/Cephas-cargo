...
export default function AdminLogin() {
  ...
  // In practice this will be served from admin.cephascargo.com so authService already picks admin-login
  ...
  <div className="relative z-10 flex flex-col justify-center px-12" style={{ color: '#FFC300' }}>
          <div className="flex items-center mb-8">
            <div>
              <img src="/cephascargo_0.png" alt="Cephas Cargo Platform" className="mb-8 w-64 h-auto" />
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center mb-6">
            <img src="/cephascargo_logo.png" alt="Cephas Cargo Logo" className="w-40 h-auto mx-auto mb-4" /> 
          </div>
