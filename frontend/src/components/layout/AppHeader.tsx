...
export function AppHeader({ sidebarCollapsed, onToggle, isMobile, mobileMenuOpen }: AppHeaderProps) {
  ...
  const handleLogout = async () => {
    // Perform logout (clears auth state/storage), then navigate to the public landing page
    // We intentionally redirect users to the landing page after logout so the public
    // marketing/landing experience is the first thing visitors see.
    await logout();
