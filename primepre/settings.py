...
# JWT settings
# Make tokens effectively non-expiring so users stay logged in until they explicitly log out.
# Note: JWTs are still signed; this change sets lifetimes to a very long duration (100 years).
# Be aware of security tradeoffs: if a token is leaked it remains valid until blacklisted on logout.
SIMPLE_JWT = {
